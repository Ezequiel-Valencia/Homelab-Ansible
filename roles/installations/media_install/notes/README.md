...
jellyfin_config_path: "{{ default_relative_docker_data_path }}/config/jellyfin"
qbit_config_path: "{{ default_relative_docker_data_path }}/config/qbittorent"
jackett_config_path: "{{ default_relative_docker_data_path }}/config/jackett"
bazarr_config_path: "{{ default_relative_docker_data_path }}/config/bazarr"
radarr_config_path: "{{ default_relative_docker_data_path }}/config/radarr"
sonarr_config_path: "{{ default_relative_docker_data_path }}/config/sonarr"
gluetun_config_path: "{{ default_relative_docker_data_path }}/config/gluetun"
lidarr_config_path: "{{ default_relative_docker_data_path }}/lidarr/config"
readarr_config_path: "{{ default_relative_docker_data_path }}/readarr/config"
